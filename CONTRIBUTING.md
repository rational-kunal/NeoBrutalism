...
1. Confirm the build is [passing in GitHub Actions](https://github.com/rational-kunal/NeoBrutalism/actions)
2. Push a release commit
   1. Create a new Main section at the top
   2. Rename the old Main section like:
          ## [1.0.5](https://github.com/rational-kunal/NeoBrutalism/releases/tag/1.0.5)
